...
<head>
    ...
    <link rel="stylesheet" href="hhttps://use.fontawesome.com/releases/v5.7.0/css/all.css">
...
<body>
	...
	<div class="intro">
		<h1 class="Name">
			  <span class="Name-part O">M</span><span class="Name-part H">ake</span>
			  <span class="Name-part O">Y</span><span class="Name-part H">our</span>
			  <span class="Name-part O">D</span><span class="Name-part H">ream</span>
			  <span class="Name-part O"></span>
			  <span class="Name-part M">SMART MYD</span>
		</h1>

	<script>
	function delayedAlert() {
	  var timeoutID = window.setTimeout(expandLogo, 600);
	}
	function expandLogo() {
...
.rightBtn .button .button-text {
  position: relative;
  z-index: 2;
}
.rightBtn .button .fill-container {
  position: absolute;
  left: 0;
  top: 50%;
  width: 100%;
...
.rightBtn .button .fill-container::after {
  content: "";
  position: absolute;
  left: 0;
  top: 0;
...
.rightBtn .button:hover .fill-container {
  transform: translateY(-50%) rotate(0);
}
.rightBtn .button:hover .fill-container::after {
    ...
    <div id="fullpage"> <!-- fullpage start-->
		...
		<div class="section" id="section7">
			<div class="wrap7">
				...
				<form id="frmcontant" name="frmcontant" type="POST" onsubmit="return goWrite();" action="https://smartmyd.com/proc/contant_write.proc.asp">
					...
					<div class="db_wrap2">
						...
						<div class="input_row">
							<div class="input_btn_wrap input_wrap3">
								<input type="submit" value="Submit" class="btn btn1 btn_ani" id="submit_bnt">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="wrap8">
				...
				<footer>
					...
					<div class="footerText">
						<p class="pc">주식회사 스마트마이디 | 대표자 장동환 | 사업자등록번호 389-87-02839</p>
						<p class="mo">주식회사 스마트마이디<br>대표자 장동환 | 사업자등록번호 389-87-02839</p>
	...
	$(function(){
		...
		$('#fullpage').fullpage({
			...
			onLeave: function(index, nextIndex, direction){
				...
				if ( nextIndex == 7 ) {
					$(".rightBtn button").css("display","none");
				} else {
					$(".rightBtn button").css("display","block");
				}
			...
			afterLoad: function(index, nextIndex, direction){
				if ( nextIndex == 2 ) {
					$("#section2 .mainTxt2").addClass("on");
				} else {
		  			$("#section2 .mainTxt2").removeClass("on");
				}
			 },
		});	
	});
